...
<style>
    .ke-container{ height:100%!important; width:100%!important;}
</style>
            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li><a href="<?php echo U('Know/helps');?>">帮助信息</a></li>
                        <li class="active">帮助信息文章列表</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card alert">
                    <div class="card-header">
                        ...
                        <div class="card-header-right-icon">
                            <ul>
                                <li class="doc-link">
                                    <a class="btn btn-xs btn-info" data-toggle="modal" data-target="#myModal">添加帮助信息文章列表</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <form name="ador">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label>文章内容</label>
                                    <textarea class="form-control" name="context" style="height:400px;" id="editor_id"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <form>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>帮助名称</label>
                                    <input type="text" name="title" class="form-control" ng-model="infos.title"/>
                                </div>
                                <div class="form-group">
                                    <label>状态</label>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label>文章内容</label>
                                    <textarea class="form-control" name="context" style="height:400px;" id="editor_s"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    KindEditor.ready(function (K) {
        sK = K;
        window.editors = K.create('#editor_s');
    });
    ...
    app.controller('myCtrl', function ($scope, $http) {
        ...
        $scope.updateinfo = function (id) {
            $scope.commAjax("<?php echo U('Core/infos','model=sys_help');?>", {ids: id}, function (res) {
                ...
                ////
                sK.insertHtml('#editor_s', res.data.context);
                $("#myEdit").modal("show");
            });
        }
