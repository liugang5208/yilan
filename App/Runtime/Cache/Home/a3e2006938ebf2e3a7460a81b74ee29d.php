            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li><a href="<?php echo U('Know/sysc');?>">系统文本</a></li>
                        <li class="active">修改系统文本</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>内容</label>
                                        <textarea name="context" id="editor_id" class="form-control input-sm" rows="25"><?php echo (htmlspecialchars_decode($info["context"])); ?></textarea>
                                    </div>
                                    <button type="button" class="btn btn-primary" onclick="addor()">修改</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function addor() {
        ...
        var baseurl = "<?php echo U('Core/edits','model=sys_article');?>";
        //////
        $.ajax({
            url: baseurl,
            type: "post",
