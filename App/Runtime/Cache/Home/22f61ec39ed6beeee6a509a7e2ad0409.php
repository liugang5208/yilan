            ...
            <div class="page-header">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li><a href="<?php echo U('Goods/plate_conts','id='.$id);?>">细分商品</a></li>
                        <li class="active">商品内容</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form name="addon">
                            ...
                            <div class="form-group">
                                <label>内容</label>
                                <textarea name="<?php echo ($tar); ?>" class="form-control" id="editor_id" rows="20"><?php echo ($context); ?></textarea>
                            </div>
...
<script>
    ...
    function addor() {
        ...
        /////////
        $.ajax({
            url: "<?php echo U('Core/change','model=plate_conts');?>",
            type: "post",
            dataType: 'json',
            data: data,
