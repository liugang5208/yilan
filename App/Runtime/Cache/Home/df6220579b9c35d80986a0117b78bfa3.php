                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>登录帐号</th>
                                        <th>帐号备注</th>
                                        <th width="100px">报价单位</th>
                                        <th width="100px">询价单位</th>
                                ...
                                <?php if(is_array($list["list"])): $k = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td><?php echo ($v["trans_bids"]); ?></td>
                                        <td>
                                            <?php echo ($v['ticket']==0?'不含税票':''); ?>
                                            <?php echo ($v['ticket']==1?'增值税普通税票':''); ?>
                                            <?php echo ($v['ticket']==2?'增值税专用税票':''); ?>
                                        </td>
                                        <td><?php echo ($v["count"]); ?></td>
                                        <td><?php echo ($v["money"]); ?></td>
                                        <td><?php echo ($v['_user']['phone']); ?></td>
                                        <td><?php echo ($v['_user']['tags']); ?></td>
                                        
                                        <td><?php echo ($v["rep_comp"]); ?></td>
                                        <td><?php echo ($v["question_comp"]); ?></td>
                                        <td><?php echo ($v["project_comp"]); ?></td>
                                        <td><?php echo ($v["check_type"]); ?></td>
                                        <td><?php echo ($v["rep_user"]); ?></td>
                                        <td><?php echo ($v["rep_phone"]); ?></td>
                                       <td><?php echo (date('Y-m-d H:i:s',$v["times"])); ?></td>
                                        <td>
                                            <a href="<?php echo U('ReportInfo/infos','id='.$v['id']);?>" class="btn btn-info btn-xs">详情</a>
