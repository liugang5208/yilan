                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <form name="ador">
                                 <input hidden name="ac_level" value="<?php echo ($ac_level); ?>" />
                                <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><input hidden name="form_data[<?php echo ($k); ?>][plate_cats_id]" value="<?php echo ($v["id"]); ?>" />
                                    <tr>
                                        <td><?php echo ($k); ?></td>
                                        <td><?php echo ($v["name"]); ?></td>
                                     
                                        <td><input name="form_data[<?php echo ($k); ?>][cats_up]" type="number" onkeydown="handleBlur(event,this,<?php echo ($ac_level); ?>,<?php echo ($v["id"]); ?>,<?php echo ($v["users_cats_up"]); ?>)"  width="100px" value="<?php echo ($v["users_cats_up"]); ?>" /></td>
...
<script>
    ...
    function addor() {
        ...
        var baseurl = "<?php echo U('Users/cats_op_form');?>";
        //////
        $.ajax({
            url: baseurl,
            type: "post",
    ...
    function change(id, st) {
        ...
        //////
        $.ajax({
            url: "<?php echo U('Core/edits','model=sys_version');?>",
            type: "post",
            data: data,
            dataType: "json",
            success: function (res) {
