                ...
                <div class="card alert">
                    <div class="card-header">
                        ...
                        <div class="card-header-right-icon">
                            <ul>
                                <li class="doc-link">
                                    <a class="btn btn-xs btn-info" href="<?php echo U('Know/index_add');?>">添加知识文章</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo (getKCatsName($v['catid'],$catid)); ?></td>
...
<script>
    ...
    function dels(id) {
        var data = {id: id};
        var baseurl = "<?php echo U('Core/dels','model=know');?>";
        //////
        $.ajax({
            url: baseurl,
            type: "post",
