                ...
                <div class="card alert">
                    <div class="card-header">
                        ...
                        <div class="card-header-right-icon">
                            <ul>
                                <li class="doc-link">
                                    <a class="btn btn-xs btn-info" data-toggle="modal" data-target="#myModal">添加系统版本</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document" style="width:35%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">添加系统版本</h4>
                </div>
...
<script>
    ...
    function addor() {
        ...
        var baseurl = "<?php echo U('Core/addon','model=sys_version');?>";
        //////
        $.ajaxFileUpload({
            url: baseurl,
            secureuri: false,
