                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <?php if(is_array($list["list"])): $i = 0; $__LIST__ = $list["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                       ...
                                       <td><?php echo ($v["normal_tax"]); ?></td>
                                        <td><?php echo ($v["special_tax"]); ?></td>
                                        <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form name="ador">
                        ...
                        <div class="form-group">
                            <label>增值税普通发票</label>
                            <input type="text" name="normal_tax" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label>增值税专用发票</label>
                            <input type="text" name="special_tax" class="form-control"/>
                        </div>
                        <!--<div class="form-group">-->
                        <!--    <label>状态</label>-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label>增值税普通发票</label>
                            <input type="text" name="normal_tax" ng-model="infos.normal_tax"  class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label>增值税专用发票</label>
                            <input type="text" name="special_tax" ng-model="infos.special_tax" class="form-control"/>
                        </div>
                        <!--<div class="form-group">-->
                        <!--    <label>状态</label>-->
